...
| [`.github/workflows/agentic-react-kit-ci.yml`](../.github/workflows/agentic-react-kit-ci.yml) | **Monorepo** root: same jobs with `agentic-reAct-kit/` paths; Docker **build context** is `agentic-reAct-kit` for the same Cloud Run image. |
...
# agentic-reAct-kit
# meridian-electronics-support-agent
